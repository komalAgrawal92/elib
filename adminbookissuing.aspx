                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" DataSourceID="SqlDataSource1">
                            <Columns>
                                <asp:DynamicField HeaderText="Member ID" DataField="member_id"></asp:DynamicField>
                                <asp:DynamicField HeaderText="Member_Name" DataField="member_name"></asp:DynamicField>
                                <asp:DynamicField HeaderText="Book_ID" DataField="book_id"></asp:DynamicField>
                                <asp:DynamicField HeaderText="Book_Name" DataField="book_name"></asp:DynamicField>
                                <asp:DynamicField HeaderText="Issue_Date" DataField="issue_date"></asp:DynamicField>
                                <asp:DynamicField HeaderText="Due_Date" DataField="due_date"></asp:DynamicField>
                            </Columns>
                        </asp:GridView>
                     </div>
                  </div>
